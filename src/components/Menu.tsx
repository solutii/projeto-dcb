...
export function MenuNavegacao() {
  ...
  const links = [
    { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, color: "from-blue-500 to-blue-700" },
    { href: "/contas-a-pagar", label: "Contas a Pagar", icon: FileText, color: "from-purple-500 to-purple-700" },
    { href: "/pedidos", label: "Pedidos", icon: ShoppingCart, color: "from-green-500 to-green-700" },
    { href: "/notas-fiscais", label: "Notas Fiscais", icon: Receipt, color: "from-orange-500 to-orange-700" },
  ];
          ...
          >
            ...
            {isActive && (
              <>
                ...
                <div className="absolute top-3 right-3 w-0.5 h-0.5 bg-white/40 rounded-full animate-pulse" />
                <div className="absolute bottom-2 left-4 w-0.5 h-0.5 bg-white/50 rounded-full animate-bounce" />
              </>
            )}
            ...
            {isActive && (
              <div className="absolute -top-2 -right-2 flex items-center justify-center">
                <div className="w-4 h-4 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full animate-pulse shadow-lg" />
                <div className="absolute w-6 h-6 bg-gradient-to-r from-yellow-400/20 to-orange-400/20 rounded-full animate-ping" />
              </div>
            )}
